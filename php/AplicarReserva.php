...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="flex-navbar">
                ...
                <ul class="navigation">
                    <li class="item"><a class="enlace" href="index.php">Inicio</a></li>
    ...
    <main class="habitacion-huesped">
        <div class="container">
            <h1 class="centro title-reservacion margin-bottom">Datos Personales para la Reservacion</h1>
                            
            <form class="form-reservacion">
                <div class="flex-Aplicar-Reservacion">
                    <div class="form-habitacion">
                        <div class="flex-cajas-h">

                            <div class="caja-h">
                                <label class="centro" for="">Fecha De Inicio Hospedaje</label>
                                <input type="text" value="<?php echo $fecha_inicio ?>">
                            </div>
        
                            <div class="caja-h">
                                <label class="centro" for="">Fecha De Fin Hospedaje</label>
                                <input type="text" value="<?php echo $fecha_fin ?>">
                            </div>
                        ...
                        </div><!---div cierre flex-cajas-h-->
                    </div><!--cierre caja formulario-->

                    <div class="form-habitacion">
                        <div class="flex-cajas-h">
                            <div class="caja-h">
                                <label class="centro" for="">Su Nombre</label>
                                <input type="text" name="txtnombre" placeholder="Firts Name">
                            </div>
    
                            <div class="caja-h">
                                <label class="centro" for="">Su Apellido</label>
                                <input type="text" name="txtapellido" placeholder="Last Name" id="">
                            </div>

                            <div class="caja-h">
                                <label class="centro" for="">Su Correo</label>
                                <input type="email" name="txtemail" placeholder="@example.com" id="">
                            </div>

                            <div class="caja-h centro">
                                <label class="centro" for="">Mensaje (Opcional)</label>
                               <textarea name="" class="tArea"></textarea>
                            </div>
                        </div><!--cierre flex-cajas-h-->
                        
                        <div class="caja-h espacio-arriba-reserva">
                            <input class="btn" type="submit" name="" value="Aplicar Reserva" id="">
                        </div>
                    </div><!--cierre caja formulario-->
                </div><!--Cierre flex-AplicarRservacion-->
            </form><!--Cierre Formulario-->


            
            <div class="img-habitacion relative">
                    <img class="anchoApliReserva" src="data:image/jpg;base64,<?= base64_encode($resultado['foto_principal']);?>" alt="Imagen de la Habitacion General">
                
                    <div class="caja-precio absolute">
                        <label class="centro title-label" for="">Habitacion Escogida</label>
                        <p class="pf-precio"><span>------------------</span></p>
                    </div>
                    <div class="caja-precio1 centro absolute">
